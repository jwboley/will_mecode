...
v = [1.0,0.1,0.01,0.001]
h0_high = 0.06 #Nozzle offset for high speed motion to initial print location
h0 = 0 #Operating nozzle offset
...
p0 = 4 #pitch for first unit meander
...
def meta_meander(xl,n,v,p0):
    for i in range(len(v)):
        unit_meander(n=n,xl=xl,p=p0,v=v[i])
...
meta_meander(xl=xl,n=n,v=v,p0=p0) 
